"""
MaskProbability (Classifier)
    - Posterior model
    - Define the probability of a class based the output of probability of a mask model and a ROI.
...
class MaskProbability(InferenceModel):
    def __init__(self, filepath, interest_labels=None, mask_label=None, threshold=0.2, labels=None, *args, **kwargs):
        ...
        self.logger.info('Instantiated MaskProbability for {}. Threshold: {}'.format(self.interest_labels, threshold))
...
if __name__ == '__main__':
    ...
    model = MaskProbability(None, interest_labels=['persona'],  mask_label='borde',
